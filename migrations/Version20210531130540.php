 ...
 */
final class Version20210531130540 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__wish AS SELECT id, name, description, price, url, image, is_offered FROM wish');
        ...
        $this->addSql('INSERT INTO wish (id, name, description, price, url, image, is_offered) SELECT id, name, description, price, url, image, is_offered FROM __temp__wish');
        $this->addSql('DROP TABLE __temp__wish');
        $this->addSql('CREATE INDEX IDX_D7D174C9FB8E54CD ON wish (wishlist_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__wishlist AS SELECT id, title, description FROM wishlist');
        ...
        $this->addSql('INSERT INTO wishlist (id, title, description) SELECT id, title, description FROM __temp__wishlist');
